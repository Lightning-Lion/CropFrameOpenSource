...
struct ShutterSoundSupport<V:Equatable>: ViewModifier {
    @State
    private var shutterSoundMod = ShutterSoundV1()
    ...
    func body(content: Content) -> some View {
        ...
        // 在拍照的同时播放音效
        .onChange(of: shutterTrigger, initial: false/*设为false，我这个ViewModifier出现不需要触发音效*/) { oldValue, newValue in
            shutterSoundMod.play()
        }
    }
}

class ShutterSoundV1 {
